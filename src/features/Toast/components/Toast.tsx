...
const ToastPortal: React.FC<ToastPortalProps> = ({ children }) => {
  const target = document.querySelector(".App.relative");
...
const Toast: React.FC<ToastProps> = ({ toast, setToast }) => {
  ...
  return (
    <ToastPortal>
      <div id={id} className="flex items-center w-full max-w-md p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 absolute top-4 right-4" role="alert">
